...
audiowrite([pathOutput filename(1:end-4) '_pitchShiftw' sprintf('%0.0f',n) 'Cents.wav'],...
            y,fsAudio);

audiowrite([pathOutput filename(1:end-4) '_pitchShiftw' sprintf('%0.0f',n) 'Cents_formantAdapted.wav'],...
